...
classical actor model \cite{Agha86-book}, but nevertheless provides communication by a
...
point-to-point FIFO adds some synchronisation and can lead to a loss of 
efficiency. The 
...
are active.
The first active object models were \emph{uniform} active object models
where all objects 
...
object 
models, where some objects are full-fledge active object with their own 
threads, and 
