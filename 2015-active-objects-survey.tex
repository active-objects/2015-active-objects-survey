...
There are several other programming languages that introduce
high-level abstractions for concurrent programming that deviate from
the active object approach. We focused in this paper on languages based on an active 
object models, numerous programming models with similar inspirations but not following 
exactly the actor paradigm exist, like for example Seuss~\cite{Misra-2001}, 
SCOOP~\cite{SCOOP93}. We give 
below an overview of the main languages that  adopt, at least partially, the concept of 
active objects.
