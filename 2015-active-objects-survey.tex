...
objects is not restricted in this way.
...
class Mtx
  ...
  def computeFastestDiagonal(): Par[Mtx]
    ...
    %\label{line:encore:chl}%fChlsk = async choleskyFact(mtx)
...
\caption{\label{fig:encore:factorisation}Data pipeline and speculative parallelism in matrix factorisation. The
