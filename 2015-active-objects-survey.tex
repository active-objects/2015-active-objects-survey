...
This configuration of objects is illustrated in Fig.~\ref{fig:ABS-to-PA-new}, where a COG is created through a new \code{Server} object.
...
\RH{Please label COGs consistently throughout the article. I suggest to use numbers: COG 1, COG 2, \ldots; please write ``COG'', not ``cog'' everywhere.}
