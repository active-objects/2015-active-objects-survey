...
\RH{this description is more detailed than those for the other languages. On the other hand, the scheduling mechanism of Encore is nearly identical to that of ABS. I suggest to either drastically shorten this paragraph or render it applicable to both ABS and Encore.}
...
\begin{figure}
  \centering
  \includegraphics[scale=0.58]{./pictures/abs8sched.png}
...
\begin{minipage}{.46\textwidth}
  \centering
   	\includegraphics[scale=0.55]{./pictures/absj8e.png}
...
until a future is fulfilled and resumed afterwards. Unlike the ProActive backend for ABS 
that relies
