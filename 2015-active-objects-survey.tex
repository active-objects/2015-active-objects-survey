...
Consequently, in ProActive all active objects are referenced in an RMI registry and can be accessed in this way from any other object through the rmi protocol. 
...
\RH{Isn't the ``rmi'' protocol not rather called JRMP?}
