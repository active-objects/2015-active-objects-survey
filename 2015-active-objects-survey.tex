...
A discussion of other hight-level concurrent languages can be found in
...
limited. In some languages (e.g. Rebeca), inspired by pure actors, there is no
...
programmer can rely. Synchronisation on futures can be explicit (e.g. ABS, Encore) or 
implicit (e.g. ASP).

Several active object languages support cooperative scheduling (e.g. ABS, Encore): a
...
point-to-point FIFO (like in Rebeca) adds some synchronisation and can lead to a loss of 
efficiency. The 
...
hidden to the programmer). For example, if futures are transparent (like in ASP),
...
are active.
The first active object models were \emph{uniform} active object models (e.g. Rebeca) 
where all objects 
...
object 
models (e.g.ASP), where some objects are full-fledge active object with their own 
threads, and 
others are passive objects, i.e. standard objects. Second, concurrent object groups (e.g. 
ABS)
...
\textbf{Degree of\newline synchro\-nization}&$\bullet$ Asynchronous \newline message
                           ...
                           requests per\newline  actor&$\bullet$ Explicit 
                           futures\newline$\bullet$ Asynchronous \newline
                                            method calls with \newline first-class
                                            futures \newline
                                            $\bullet$ Advanced\newline 
                                            synchronization\newline
